...
- `expanded_entities` — related entities (1-3 hops out) with hop distance and weight. If context is insufficient, query specific expanded entities for more detail
